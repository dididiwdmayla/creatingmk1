...
/**
 * Mesmo bug corrigido na skin de tatuagem (ver SectionReveal.test.tsx de
 * lá): `viewport.amount` fixo (ex.: 0.2) exige essa fração da área TOTAL
 * da seção visível de uma vez — inatingível quando a seção (lista de
 * tamanho livre) fica muito mais alta que a viewport. "some" corrige.
 */
...
describe("SectionReveal (barbearia) — reveal por scroll não trava em seções altas", () => {
