 ...
 *
 * Nesta skin o wrapper só entra em cena quando o editor pede um override
 * explícito (ver `wrapperTipo` em Skin.tsx) — o default do template usa
 * `Reveal` por elemento, fiel ao `data-reveal` do material bruto.
 */
...
export function SectionReveal({
  ...
  return (
    <motion.div
      ...
      transition={{ duration: preset.duration, ease: [0.22, 0.61, 0.21, 1] }}
    >
      {children}
    </motion.div>
  );
