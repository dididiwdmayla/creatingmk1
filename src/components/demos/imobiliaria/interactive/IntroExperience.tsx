...
const SESSION_KEY = "demo-imobiliaria-intro-vista";
const DURACAO_MS = 1100;

/**
 * Splash de abertura opcional (Theme.intro) — o material bruto carrega
 * direto no hero, sem nenhuma tela de abertura, então o toggle fica
 * desligado em todos os presets por padrão; se o editor ligar, mostra uma
 * revelação curta da marca (chrome fixo, sem dependência de dado do lead
 * além do nome), mesmo padrão das demais skins. Uma vez por sessão
 * (sessionStorage).
 */
        ...
        {mostrando && (
          ...
          >
            <motion.span
              ...
              className="rounded-full px-8 py-4 font-[family-name:var(--d-display)] text-2xl italic tracking-tight md:text-4xl"
