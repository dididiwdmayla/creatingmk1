 ...
 * de mais nada. Extraído de qa-diff.mjs quando um segundo laço (qa-aura.mjs)
 * passou a precisar dos mesmos pixels — a medição de estouro em branco lê a
 * captura, não a compara com outra.
 */
...
/** Mesma decodificação, a partir do buffer — os quadros que chegam pelo
 * screencast do CDP vêm em base64, nunca tocam o disco. */
