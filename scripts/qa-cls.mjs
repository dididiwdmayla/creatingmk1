...
function semear() {
  ...
  // linha do país ABRIR com os leads já pagos na tela /mundo, em vez de
  // mandar direto pra busca — é o estado com mais conteúdo, e portanto o
  // que mais tem a deslocar depois do primeiro desenho.
  const paisesMundo = [
